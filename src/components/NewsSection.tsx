      ...
      try {
        ...
        setTimeout(() => {
          const mockNews: NewsItem[] = [
            ...
            {
              id: '2',
              title: 'Мария Зайцева представила рассматривает вакансии для backend-разработчиков',
              description: 'Автор этого пет-проекта готова присоединиться к крутым проектам!',
